  ...
  return (
    ...
    >
      ...
      <button 
        ...
        className='inline-flex items-center gap-2 px-12 py-3 rounded-full bg-black text-white hover:scale-105 transition-all duration-500 focus:outline-none focus:ring focus:ring-gray-400'
      >
        Generate Images
        <img 
