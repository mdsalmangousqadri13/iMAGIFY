...
//          <p onClick={()=>{setsImageLoaded(false)}}
  ...
  return (
    ...
    >
      ...
      <div className='relative'>
        ...
        {loading && (
          <span className='absolute bottom-0 left-0 h-1 bg-blue-500 w-full transition-all duration-[2.5s] animate-pulse' />
        )}
      </div>

      {/* Loading Message */}
      {loading && <p className='text-gray-500 mt-4'>Generating... Please wait</p>}
